...
<main class="page-content">
  ...
  <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
      ...
      <a type="button" class="btn btn-success" href="<?= base_url('fornecedores/add') ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Filtrar Fornecedores</h5>
            ...
            <div class="modal-body">
              ...
              <div class="col-md-12">
                <label for="razaoSocialFiltrar" class="form-label">Razão Social</label>
                <input type="text" class="form-control" id="razaoSocialFiltrar">
              </div>
              <div class="row">
                <div class="col-md-6">
                    <label for="tipoFiltrar" class="form-label">Tipo</label>
                    <select id="tipoFiltrar" class="form-select">
