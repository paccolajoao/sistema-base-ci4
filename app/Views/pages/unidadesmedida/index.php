...
<main class="page-content">
  ...
  <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
      ...
      <a type="button" class="btn btn-success" href="<?= base_url('unidadesmedida/add') ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Filtrar Unidades de Medida</h5>
            ...
            <div class="modal-body">
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <label for="relacionalFiltrar" class="form-label">Relacional</label>
                    <select id="relacionalFiltrar" class="form-select">
